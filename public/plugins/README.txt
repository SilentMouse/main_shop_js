...
support various features (e.g. sliders). IDea template includes
...
1) PREMIUM PLUGINS
  ...
  the slider-revolution plugin must only be used within IDea template.
...
our support.
  ...
  2-a) UPDATE A PLUGIN
    ...
    IDea template is a static HTML template so you have to update
  ...
  2-b) REMOVE A PLUGIN
    ...
    d) Delete the css and js references from your HTML files e.g. for owl carousel plugin
    these:
    <link href="plugins/owl-carousel/assets/owl.carousel.css" rel="stylesheet">
    <link href="plugins/owl-carousel/assets/owl.theme.default.min.css" rel="stylesheet">
    are the css references, and this:
    <script src="plugins/owl-carousel/owl.carousel.js"></script> is the js reference.
    ...
    need assistance in order to remove a plugin contact support. 

  2-c) PLUGINS LIST

    You will find the detailed list of plugins that are used in IDea template

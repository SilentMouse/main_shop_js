...
import MediaInCard from "../MediaInCard"
                                    ...
                                    <div className="row">
                                        <div className="col-md-4">
                                            ...
                                            <ul className="nav nav-pills white space-top" role="tablist">
                                                <li className="active"><a href="#product-images" role="tab"
                                                                          data-toggle="tab" title="images"><i
                                                    className="fa fa-camera pr-5"></i> Фото</a></li>
                                                <li><a href="#product-video" role="tab" data-toggle="tab" title="video"><i
                                                    className="fa fa-video-camera pr-5"></i> Видео</a></li>
                                            </ul>
                                            ...
                                            <div className="tab-content clear-style">
                                                ...
                                                <div className="tab-pane" id="product-video">
                                                    <div className="overlay-container margin-top-clear">
                                                        ...
                                                        <a href="/images/page-about-1.jpg" className="popup-img overlay"
                                                ...
                                                <div className="side product-item vertical-divider-left">
                                                    <div className="tabs-style-2">
                                                        ...
                                                        <ul className="nav nav-tabs" role="tablist">
                                                            <li className="active"><a href="#h2tab1" role="tab"
                                                                                      data-toggle="tab"><i
                                                                ...
                                                                <div className="comments margin-clear space-top">
                                                                    ...
                                                                    <div className="comment clearfix">
                                                                        ...
                                                                        <div className="comment-content">
                                                                            <h3>Amazing!</h3>
                                                                            <div className="comment-meta"><i
                                                                                className="fa fa-star text-default"></i>
                                                                                <i className="fa fa-star text-default"></i>
                                                                                <i className="fa fa-star text-default"></i>
                                                                                <i className="fa fa-star text-default"></i>
                                                                                <i className="fa fa-star"></i> | Today,
                                                                                12:31
                                                                            </div>
